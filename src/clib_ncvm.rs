...
pub const NCVM_FUNCTION_NOT_FOUND: u32 = 8;
pub const NCVM_STACK_OVERFLOW: u32 = 9;
pub const NCVM_STACK_UNDERFLOW: u32 = 10;
pub const NCVM_CALL_STACK_OVERFLOW: u32 = 11;
pub const NCVM_MIN_VERSION: u32 = 1;
pub const NCVM_VERSION: u32 = 1;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ncvm_pub_function {
    pub name: *mut ::std::os::raw::c_char,
    pub addr: ::std::os::raw::c_ulong,
}
#[test]
fn bindgen_test_layout_ncvm_pub_function() {
    const UNINIT: ::std::mem::MaybeUninit<ncvm_pub_function> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<ncvm_pub_function>(),
        16usize,
        concat!("Size of: ", stringify!(ncvm_pub_function))
    );
    assert_eq!(
        ::std::mem::align_of::<ncvm_pub_function>(),
        8usize,
        concat!("Alignment of ", stringify!(ncvm_pub_function))
    );
    assert_eq!(
...
pub struct ncvm {
    ...
    pub pub_functions: *mut ncvm_pub_function,
    pub pub_functions_count: ::std::os::raw::c_ulong,
}
#[test]
fn bindgen_test_layout_ncvm() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).pub_functions) as usize - ptr as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(ncvm),
            "::",
            stringify!(pub_functions)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).pub_functions_count) as usize - ptr as usize },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(ncvm),
            "::",
            stringify!(pub_functions_count)
        )
    );
}
#[repr(C)]
...
extern "C" {
    pub fn ncvm_find_function_addr(
        vm: *mut ncvm,
        name: *const ::std::os::raw::c_char,
